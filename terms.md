...
If Customer has a separate signed agreement or order form with Bounty that applies to the same service, that agreement controls over these Terms to the extent of any conflict.
...
Customer grants Bounty a limited license to process Customer Data only as needed to provide, secure, support, maintain, and improve the service; comply with law; and enforce these Terms.
...
Bounty may allow Customer to connect customer-authorized data sources and tools, such as advertising platforms, analytics tools, CRM systems, lifecycle messaging tools, customer warehouses, and other business systems.
...
Fees, subscription periods, payment terms, taxes, renewal terms, and usage limits are stated in the applicable order form, checkout flow, invoice, pricing page, or other written agreement.
...
Customer may provide feedback or suggestions. Bounty may use feedback without restriction or obligation.

## 11. Service Changes And Availability

Bounty may update, modify, suspend, or discontinue parts of the service. Bounty will use reasonable efforts to avoid materially reducing core paid functionality during a subscription period.
...
Customer may stop using the service or terminate as stated in the applicable order form or subscription terms.
...
Except as expressly stated in a written agreement, neither party is liable for indirect, incidental, special, consequential, exemplary, or punitive damages, or lost profits, revenues, goodwill, or data, to the extent permitted by law.

## 15. Indemnity

Customer will defend and indemnify Bounty against third-party claims arising from Customer Data, Customer's use of the service, Customer's breach of these Terms, or Customer's violation of law or third-party rights.

## 16. Data Protection

The [Privacy Policy](/privacy) describes Bounty's privacy practices. The [Data Processing Addendum](/dpa) applies when accepted by the parties or incorporated into the applicable agreement.

## 17. Governing Law And Disputes

Governing law, venue, arbitration, waiver, and other dispute terms are stated in the applicable signed agreement or order form. If no separate agreement applies, disputes will be handled by courts with jurisdiction over Bounty and the dispute.

## 18. Contact

Legal, privacy, and security notices can be sent to [arran@bountygrowth.com](mailto:arran@bountygrowth.com).
