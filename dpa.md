...
This Data Processing Addendum ("DPA") forms part of the agreement between Bounty and the customer identified in that agreement ("Customer") governing Customer's use of the Service (the "Agreement"), including any subsequent agreements, statement of work or renewals entered into by the parties, unless the parties expressly agree otherwise in writing. It applies when Bounty handles Customer Personal Data on Customer's behalf.
...
**1.1 Applicable Privacy Law.** means the Privacy Act 1988 (Cth), the Australian Privacy Principles and any other Australian privacy or data protection law that applies to the handling of Customer Personal Data under the Agreement. Where the parties agree that Customer Personal Data from another jurisdiction may be provided under the Agreement, the applicable privacy or data protection law of that jurisdiction will also be included within this definition.
...
**1.3 Security Incident.** means a confirmed breach of security that results or may result in accidental or unlawful destruction, loss, alteration, unauthorised disclosure of, or access to Customer Personal Data.
...
**3.2 Required handling.** Bounty may handle Customer Personal Data where required by Applicable Privacy Law. Unless prohibited, Bounty will notify Customer of the requirement before doing so.
...
**5.1 Notification.** Bounty will notify Customer without undue delay after becoming aware of a Security Incident and, in any event, no later than 24 hours. Notice will be sent to Customer's designated account or security contact.

**5.2 Response.** Bounty will take reasonable steps to contain, investigate, mitigate and remediate the Security Incident and will provide information reasonably available to Bounty that Customer needs to assess the incident and meet applicable notification obligations. Bounty will not make public statements regarding a Security Incident involving Customer Personal Data without Customer's prior written consent, except as required by law.

**5.3 No admission.** Notification or assistance concerning a Security Incident is not an admission of fault or liability.

## 6. Subprocessors

**6.1 Authorisation.** Bounty will give Customer 5 days' prior written notice before engaging any new Subprocessor. If Customer objects on reasonable grounds within that notice period, Bounty will use commercially reasonable efforts to continue providing the Service without that Subprocessor. If this is not possible within a reasonable time, the Customer may terminate the affected portion of the Service, with a pro-rated refund to Customer if applicable.

**6.2 List.** Bounty's current Subprocessor list is published at https://docs.bountygrowth.com/subprocessors.

**6.3 Protections.** Bounty will impose written data-protection obligations appropriate to each Subprocessor's services and remains responsible for its Subprocessors' acts or omissions as if performed by Bounty directly to the extent required by Applicable Privacy Law and the Agreement.

## 7. Overseas processing

**7.1 Locations.** Customer authorises Bounty and its Subprocessors to handle Customer Personal Data in Australia and the United States. Bounty's primary application and analytics data stores are hosted in AWS region us-east-2 (Ohio), United States. Customer Personal Data will not be relocated to, or accessed from, a location outside Australia and the United States without Customer's prior written consent, except as disclosed in the Subprocessor list at the time of Customer's agreement to this DPA. Other Subprocessor locations are shown on Bounty's Subprocessor list; Customer-selected integrations may use the locations of those services.
...
**9.2 Review process.** Further review is available only where required by Applicable Privacy Law, a regulator or a Security Incident and must begin remotely using available documents. An on-site inspection is permitted only if remote material is insufficient to meet a legal requirement. Reviews must be coordinated in advance, avoid unreasonable disruption, and protect Bounty's and other customers' confidential information.
...
**10.1 Post-termination handling.** Handling of Customer Personal Data after expiration or termination of the Agreement is governed by the DPA and Applicable Privacy Law. Upon termination or expiration of this Agreement, Bounty shall securely delete all Customer Personal Data (including sub-processor copies), and provide written certification within 30 days.
